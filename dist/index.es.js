...
import { FileIcon, ImagePreviewer, FilePreviewer, ImageDropzone, FileUploadButton, dataTransferItemsHaveFiles, dataTransferItemsToFiles, LoadingIndicator } from 'react-file-utils';
  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("img", {
        ...
        alt: fallback
      }), React__default.createElement(ModalGateway, null, this.state.modalIsOpen ? React__default.createElement(Modal, {
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(LoadingIndicator$$1, _React$PureComponent);

  function LoadingIndicator$$1() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, LoadingIndicator$$1);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LoadingIndicator$$1)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(LoadingIndicator$$1, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          size = _this$props.size,
  ...
  return LoadingIndicator$$1;
}(React__default.PureComponent);

_defineProperty(LoadingIndicator$1, "propTypes", {
...
_defineProperty(LoadingIndicator$1, "defaultProps", {
  size: 15,
  color: '#006CFF'
});
...
function (_React$PureComponent) {
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement("p", null, images.length - 3, " more")), React__default.createElement(ModalGateway, null, this.state.modalIsOpen ? React__default.createElement(Modal, {
        onClose: this.toggleModal
      }, React__default.createElement(Carousel, {
        views: formattedArray,
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(Modal$$1, _React$PureComponent);
  ...
  function Modal$$1() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Modal$$1)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(ChatAutoComplete, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(ReactTextareaAutocomplete, {
        loadingComponent: LoadingIndicator$1,
...
function (_PureComponent) {
  ...
  function MessageSimple() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderStatus", function () {
      ...
      if (message.status === 'sending') {
        ...
        }, React__default.createElement(Tooltip, null, "Sending..."), React__default.createElement(LoadingIndicator$1, null));
  ...
  _createClass(MessageSimple, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, editing && React__default.createElement(Modal$1, {
        open: editing,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _this.props.addNotification(successMessage ? successMessage : 'Message has been successfully flagged', 'success');
...
function (_PureComponent) {
  ...
  _createClass(MessageList, [{
    ...
    value: function render() {
      ...
      var DateSeparator$$1 = this.props.dateSeparator;
      var HeaderComponent = this.props.HeaderComponent;
      var EmptyStateIndicator$$1 = this.props.EmptyStateIndicator; // sort by date
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        ...
        }, React__default.createElement(LoadingIndicator$1, {
          size: 20
        }))
      }, React__default.createElement("ul", {
...
for (var _i = 0, _colors = colors; _i < _colors.length; _i++) {
  ...
  try {
    for (var _iterator = baseUseCases[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var useCase = _step.value;
    }
  } catch (err) {
    _didIteratorError = true;
    _iteratorError = err;
  ...
  _createClass(ChannelHeader, [{
    ...
    value: function render() {
      return React__default.createElement("div", {
        ...
        fillRule: "evenodd"
      }))), React__default.createElement("select", null, " Sprachen", React__default.createElement("option", {
        value: "English"
      }, "English"), React__default.createElement("option", {
        value: "Deutsch"
      }, "Deutsch"), React__default.createElement("option", {
        value: "Spanisch"
      }, "Spanisch"), React__default.createElement("img", {
        src: chevrondown
      })))));
    }
  }]);
...
function (_React$PureComponent) {
  ...
  _createClass(LoadMoreButton, [{
    ...
    value: function render() {
      ...
      }, this.props.refreshing ? React__default.createElement(LoadingIndicator, null) : this.props.children));
    }
  }]);
...
_defineProperty(InfiniteScrollPaginator, "defaultProps", {
  LoadingIndicator: React__default.createElement(LoadingIndicator, null)
});
  ...
  function MessageTeam() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderStatus", function () {
      ...
      if (message.status === 'sending') {
        ...
        }, React__default.createElement(Tooltip, null, "Sending..."), React__default.createElement(LoadingIndicator$1, {
          isLoading: true
        }));
      } else if (readBy.length !== 0 && !threadList && !justReadByMe) {
        var lastReadUser = readBy.filter(function (item) {
  ...
  _createClass(MessageTeam, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          handleOpenThread = _this$props2.handleOpenThread,
          Message = _this$props2.Message,
          messageListRect = _this$props2.messageListRect,
...
function (_React$PureComponent2) {
  ...
  _createClass(ThreadInner, [{
    ...
    value: function render() {
      ...
      }, "Start of a new thread"), React__default.createElement(MessageList, {
